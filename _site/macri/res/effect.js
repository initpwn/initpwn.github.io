...
$('document').ready(function(){
	...
	$('#balloons_flying').click(function(){
		...
		$(this).fadeOut('slow').delay(5000).promise().done(function(){ //5
	...
	$('#cake_fadein').click(function(){
		$('.cake').fadeIn('slow');
		$(this).fadeOut('slow').delay(3000).promise().done(function(){ //3
	...
	$('#story').click(function(){
		...
		function msgLoop (i) {
			...
			if(i==50){
				...
				var r= $('<input type="button" class="btn btn-primary" value="Hear me once again!" onclick="location.href=\'../index.html\'"/>');
						$("#bhere").append(r);
			}
			else{
				msgLoop(i);						
