...
function changeInstruction() {
    if (App.clickCount === 10) {
        ...
        setTimeout(function() {
            $('#instruction-text').text('ab, ye gifts mei click karooo. (Sound volume up) :)');
    ...
    if (App.clickCount === 15) {
        ...
        setTimeout(function() {
            $('#instruction-text').text('Happy Birthday dudyyyyy!!');
            $('#instruction-text').removeClass();
            $('#instruction-text').addClass('animated bounceInDown')
        }, 200);
    ...
    if (App.clickCount === 30) {
        $('#instruction-text').addClass('animated rollOut');
        setTimeout(function() {
            $('#instruction-text').html('<a href="loader.html"> Now, click here to see a small ASCII art. :P </a>');
            $('#instruction-text').removeClass();
            $('#instruction-text').addClass('animated bounceInDown')
        }, 200);
